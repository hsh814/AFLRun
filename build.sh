...
hash -r
LLVM_CONFIG="$PATH_TO_INSTALL/bin/llvm-config" CC="$PATH_TO_INSTALL/bin/clang" CXX="$PATH_TO_INSTALL/bin/clang++" make ASAN_BUILD=1 CFLGAS="-g -O0" CXXFLAGS="-g -O0" clean all -j 32